...
public class MapGen : MonoBehaviour
{
    ...
    public NoiseGen.NormalizeMode normalizeMode;
     ...
     // max size that is a factor of 8 since max verts can be 65025 per mesh. EDIT reduced to 239 to allow for a border edge
    ...
    {
        MeshData meshData = MeshGen.GenerateMesh(mapData.heightMap, meshHeightMultiplier, meshHeightCurve, lod, useFlatShading);
